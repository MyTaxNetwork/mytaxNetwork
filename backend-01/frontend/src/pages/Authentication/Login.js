...
// import images
import logo from "../../assets/images/authors-haven.png";
            ...
            <Col md={10}>
              <div className="text-center mb-5">
                ...
                <p className="font-size-15 text-muted mt-3">
                  <b>My Tax Network</b> Admin Dashboard
                </p>
              </div>
                    ...
                    <div className="p-lg-5 p-4">
                      <div>
                        ...
                        <p className="text-muted">
                          Sign in to continue to My Tax Network.
                        </p>
                      </div>
              ...
              <div className="mt-5 text-center">
                <p>© {new Date().getFullYear()} My Tax Network</p>
              </div>
            </Col>
          </Row>
        </Container>
