...
import Client_DB from "../pages/Utility/Dashboard_Client";
...
import NewFiling from "../pages/Dashboard/NewFiling";
//Adanace kit
...
const userRoutes = [
  ...
  { path: "/new-filing", component: NewFiling },
  { path: "/clients", component: Client_DB },
